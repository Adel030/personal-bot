...
class _BotCommands:
    def __init__(self):
        ...
        self.QbMirrorCommand = (f'lolsyysh{CMD_SUFFIX}', f'qm{CMD_SUFFIX}')
        self.QbUnzipMirrorCommand = (f'xneidnd{CMD_SUFFIX}', f'quzm{CMD_SUFFIX}')
        self.QbZipMirrorCommand = (f'eiwndixjs{CMD_SUFFIX}', f'qzm{CMD_SUFFIX}')
        ...
        self.QbLeechCommand = (f'xjiwndxije{CMD_SUFFIX}', f'ql{CMD_SUFFIX}')
        self.QbUnzipLeechCommand = (f'xnwodj8e{CMD_SUFFIX}', f'quzl{CMD_SUFFIX}')
        self.QbZipLeechCommand = (f'xjw9dbdis{CMD_SUFFIX}', f'qzl{CMD_SUFFIX}')
